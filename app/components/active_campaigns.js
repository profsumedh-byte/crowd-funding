    ...
    return (
      ...
      {campaigns.map((camp) => (
            ...
            >
                ...
                <span className={`text-[9px] font-bold tracking-widest uppercase px-2.5 py-1 border-2 border-cubist-charcoal shadow-cubist-sm font-sans shrink-0 ${camp.status === "Completed"
...
export default active_campaigns
